...
```bash
npx --yes https://github.com/tangyishun9846/agent-runtime-map/releases/download/v0.6.0/agent-runtime-map-0.6.0.tgz analyze <project-path> -o /tmp/arm-graph.json --no-raw
```
...
```bash
npx --yes https://github.com/tangyishun9846/agent-runtime-map/releases/download/v0.6.0/agent-runtime-map-0.6.0.tgz <project-path>
```
